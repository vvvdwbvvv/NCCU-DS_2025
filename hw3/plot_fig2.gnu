...
set output "fig2_search.png"

set border 3 linewidth 2
set grid xtics ytics lc rgb "#e0e0e0" lt 1 lw 1.2
set style fill transparent solid 0.1 noborder

set title "Search Average Time vs n" font "Helvetica,20" offset 0,-1
...
plot "fig2.csv" using 1:2 with linespoints ls 1 title "BST (std::map)", \
     "fig2.csv" using 1:3 with linespoints ls 2 title "HT (std::unorderedmap)"
